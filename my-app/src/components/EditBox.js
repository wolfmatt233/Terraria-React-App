...
export default function EditBox(props) {
  ...
  const [spawnRequirement, setSpawnRequirement] = useState(
    props.npc.spawnRequirement
  );
    ...
    >
      ...
      >
        ...
        <TextField
          ...
          onChange={(e) => {
            setSpawnRequirement(e.target.value);
          }}
        />
        <TerrariaButton
          variant="contained"
          onClick={() => {
            //make new edit command from data store to change data
            new editCommand(
              props.npc.id,
              name,
              description,
